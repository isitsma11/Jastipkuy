...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    jastipKuyAuthUserSubject.add(
      JastipKuyAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<JastipKuyAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  JastipKuyAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = JastipKuyAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    jastipKuyAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }

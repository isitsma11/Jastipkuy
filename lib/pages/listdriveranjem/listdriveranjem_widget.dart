...
import 'listdriveranjem_model.dart';
export 'listdriveranjem_model.dart';

class ListdriveranjemWidget extends StatefulWidget {
  const ListdriveranjemWidget({super.key});

  @override
  State<ListdriveranjemWidget> createState() => _ListdriveranjemWidgetState();
}

class _ListdriveranjemWidgetState extends State<ListdriveranjemWidget>
    with TickerProviderStateMixin {
  late ListdriveranjemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListdriveranjemModel());
